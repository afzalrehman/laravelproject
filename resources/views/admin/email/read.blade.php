                        ...
                        <div class="col-lg-9">
                            <div class="d-flex align-items-center justify-content-between p-3 border-bottom tx-16">
                                ...
                                <div>
                                    ...
                                    <a href="{{url('admin/email/single_delete/'.$getRecord->id)}}"><i data-feather="trash" class="text-muted icon-lg"></i></a>
                                </div>
                            </div>
                            <div class="d-flex align-items-center justify-content-between flex-wrap px-3 py-2 border-bottom">
                                ...
                                <div class="tx-13 text-muted mt-2 mt-sm-0">{{date('d M' , strtotime($getRecord->create_at))}}</div>
                            </div>
